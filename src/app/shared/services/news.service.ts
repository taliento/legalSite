  ...
  getAll(): Promise<Array<News>> {
    return new Promise<Array<News>>((resolve,reject) => {
      try {
        ...
        news.push(new News('1','prima','la prima news','<p>LA PRIMA NEWS Aliquam sodales purus nunc,</p><p> at ultricies turpis egestas at. Mauris semper</p><p> et turpis eu aliquet. Nullam in vehicula ex. Vivamus</p><p> feugiat nulla lacus, ac euismod ligula euismod quis.</p><p> Ut dapibus ante lectus, a elementum sapien</p><p> cursus ut. Nunc at mauris id dui posuere interdum at</p><p> sed orci. Morbi sem quam, maximus ut metus non, finibus</p><p> eleifend nibh.</p>', new Date()));
